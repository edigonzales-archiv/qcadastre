...
<qgis version="2.1.0-Master" minimumScale="-4.65661e-10" maximumScale="6000" minLabelScale="0" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <customproperties>
    ...
    <property key="labeling/fontSize" value="12.6"/>
  ...
  <displayfield>objektname_von</displayfield>
  <label>0</label>
  <labelattributes>
  ...
  <edittypes>
    ...
    <edittype labelontop="0" editable="1" type="0" name="objektname_von"/>
    <edittype labelontop="0" editable="1" type="0" name="objektnamepos_von"/>
