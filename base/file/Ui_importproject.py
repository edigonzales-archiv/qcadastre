...
#
# Created: Sun Nov  3 11:57:16 2013
...
class Ui_ImportProject(object):
    def setupUi(self, ImportProject):
        ...
        self.gridLayout_4.addWidget(self.lineEditIliModelName, 1, 2, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.lblProjectName, 3, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.lineEditDbSchema, 3, 2, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.cmbBoxAppModule, 4, 2, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.btnProjectName, 3, 3, 1, 1)
        self.dateTimeEdit = QtGui.QDateTimeEdit(self.groupBox)
        self.dateTimeEdit.setObjectName(_fromUtf8("dateTimeEdit"))
        self.gridLayout_4.addWidget(self.dateTimeEdit, 5, 2, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.lineEditRefFrame, 2, 2, 1, 1)
